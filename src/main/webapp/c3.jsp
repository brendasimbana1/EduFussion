...
<%
String nombre="La biología completa de la respiración en las plantas | Glucólisis";
Curso c = new Curso();
String usuario;
	...
	<main>
		<section>
			<div class="contenedor">
				<h2>La biología completa de la respiración en las plantas | Glucólisis</h2>
				<img class="imagen_curso" alt="c3" src="resources/c3.png">
			</div>
			...
			<div class="contenedor">
				<div class="cuadro">
					...
					<tr>
						<th>Descripción: </th>
						<td>Vía de la glucólisis para la producción de ATP. Enzimas involucradas durante el proceso.</td>
					</tr>
					<tr>
				...
				<div class="cuadro">
					...
					<ol style="list-style-type: square;">
						<li>Biología Respiración</li>
						<li>Glucólisis y síntesis de ATP.</li>
						<li>Enzima PFK-1 y PFK-2</li>
						<li>Glucólisis completa y preguntas MCQ en Glucólisis.</li>
					</ol>
				</div>
			</div>
			<div class="contenedor">
