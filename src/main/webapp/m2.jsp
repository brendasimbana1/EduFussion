		...
		<section>
			...
			<div class="contenedor">
				<div class="cuadro">
					...
					<tr>
						<th>Descripción: </th>
						<td>Ecuación diferencial de primer orden y primer grado: ecuación diferencial exacta y lineal, ecuación diferencial de Bernoulli</td>
					</tr>
					<tr>
				...
				<div class="cuadro">
					...
					<ol style="list-style-type: square;">
						<li>Concepto de ecuación diferencial ordinaria</li>
						<li>Orden y grado de ecuación diferencial</li>
						<li>Solución general y particular de ecuación diferencial</li>
						<li>Formación de ecuación diferencial</li>
						<li>Ecuación diferencial de Bernoulli</li>
					</ol>
				</div>
			</div>
			<div class="contenedor">
