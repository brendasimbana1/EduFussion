...
<%
String nombre="Introducción al Pensamiento Matemático";
Curso c = new Curso();
String usuario;
	...
	<main>
		<section>
			<div class="contenedor">
				<h2>Introducción al Pensamiento Matemático</h2>
			...
			<div class="contenedor">
				<div class="cuadro">
					...
					<tr>
						<th>Descripción: </th>
						<td>Aprenda a pensar como lo hacen los matemáticos, un poderoso proceso cognitivo desarrollado 
						a lo largo de miles de años. Pensar matemáticamente no es lo mismo que hacer matemáticas, al 
						menos no como se presentan habitualmente las matemáticas en nuestro sistema escolar.  </td>
					</tr>
					<tr>
