...
<%
String nombre="Introducción a la Química: Reacciones y relaciones";
Curso c = new Curso();
String usuario;
	...
	<main>
		<section>
			<div class="contenedor">
				<h2>Introducción a la Química: Reacciones y relaciones</h2>
			...
			<div class="contenedor">
				<div class="cuadro">
					...
					<tr>
						<th>Descripción: </th>
						<td>Tiene el objetivo de preparar a los estudiantes para estudios posteriores en química, 
						necesarios para muchas profesiones científicas, sanitarias y políticas.</td>
					</tr>
					<tr>
				...
				<div class="cuadro">
					...
					<ol style="list-style-type: square;">
						<li>Conceptos básicos relacionados con las reacciones químicas</li>
						<li>La estequiometría</li>
						<li>La tabla periódica</li>
						<li>Las tendencias periódicas </li>
						<li>La nomenclatura</li>
						<li>La resolución de problemas químicos</li>
					</ol>
				</div>
			</div>
			<div class="contenedor">
